...
if __name__ == "__main__":
    freeze_support()
    print(clear_screen)
    local_version_brain_ex:float = 0.0
    telegram_token:str = ''
    telegram_channel_id:str = ''
    telegram_enable:bool = False
    continue_point_ex:int = -1
    th:int = 1
    bfbtc_dir:str = ''
    bfeth_dir:str = ''
    bfalt_dir:str = ''
    ...
    minout = False
    raw:bool = False
    th, bfbtc_dir, bfeth_dir, bfalt_dir, telegram_enable, id, desc, save, minout, raw  = createParser()

    data_local = load_configure('setings.json')
    try:
        local_version_brain_ex:float = data_local['general']['version_brain_ex']
